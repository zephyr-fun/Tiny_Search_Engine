...
#LastEditors: zephyr
#LastEditTime: 2020-12-19 18:05:56
#FilePath: \IR_codes\myindex\use_index.py
#
...
if __name__ == '__main__':
    # indexpath="D:/index"    #索引存放位置
    # datapath="D:/data"      #数据存放位置
    ...
    key="信息"         #检索关键词
    indexpath="../index"        #索引位置
    result_list = search(key,indexpath)

    resnum = len(result_list)
    end = time.time()
    print("time: %.6fs" % (end - start))
    print("result:",resnum)